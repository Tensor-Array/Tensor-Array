...
#define USING_DATA_TYPE_SINT_TO (int16_t)(int32_t)(int64_t)
#define USING_DATA_TYPE_UINT_TO (uint16_t)(uint32_t)(uint64_t)
#define USING_DATA_TYPE_SINT_FROM USING_DATA_TYPE_SINT_TO (int8_t)
#define USING_DATA_TYPE_UINT_FROM USING_DATA_TYPE_UINT_TO (uint8_t)

#define USING_DATA_TYPE_CAST_FROM \
(bool) \
USING_DATA_TYPE_SINT_FROM \
USING_DATA_TYPE_UINT_FROM \
USING_DATA_TYPE_FLOAT \
USING_DATA_TYPE_NVIDIA_FLOAT \
USING_DATA_TYPE_NVIDIA_FLOAT_8

#define USING_DATA_TYPE_CAST_TO \
USING_DATA_TYPE_SINT_TO \
USING_DATA_TYPE_UINT_TO \
USING_DATA_TYPE_FLOAT
